...
public class OrderLineServiceImpl implements OrderLineService {
    ...
    public List<OrderLine> getOrderLinesByOrderId(Long orderId) {
        LambdaQueryWrapper<OrderLine> queryWrapper = Wrappers.lambdaQuery();
        queryWrapper.eq(OrderLine::getOrderId, orderId);
        return orderLineMapper.selectList(queryWrapper);
    }
